...
curl -sO https://raw.githubusercontent.com/martinspaniol/Homelab/main/Kubernetes/RKE2/kube-vip
cat kube-vip | sed 's/$interface/'$interface'/g; s/$vip/'$vip'/g; s/$kvversion/'$kvversion'/g' > $HOME/kube-vip.yaml
...
curl -sO https://raw.githubusercontent.com/martinspaniol/Homelab/main/Kubernetes/RKE2/ipAddressPool
...
kubectl apply -f https://raw.githubusercontent.com/martinspaniol/Homelab/main/Kubernetes/RKE2/l2Advertisement.yaml
